...
* [Проект / Project](docs/project/project.md)
  * [Контекст компіляції / Compilation Context](docs/project/compilation-context.md)
    * [tsconfig.json](docs/project/tsconfig.md)
    * [Які файли / Which Files?](docs/project/files.md)
  * [Простори Оголошень / Declaration Spaces](docs/project/declarationspaces.md)
  * [Модулі / Modules](docs/project/modules.md)
